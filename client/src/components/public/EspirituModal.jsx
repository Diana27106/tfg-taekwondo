...
/**
 * Modal informativo sobre el principio de Espíritu Indomable.
 * 
 * @component
        ...
        >
            ...
            >
                ...
                <div className="relative z-10 flex h-[180px] md:h-[280px] items-center justify-center pt-6 md:pt-8">
                    <Flame size={100} strokeWidth={1.5} className="text-orange-500 fill-orange-400 transition-all md:scale-125" />
                </div>
                ...
                <div className="relative z-10 px-6 md:px-8 pb-10 md:pb-16 pt-4 md:pt-8 text-center">
                    ...
                    <p className="text-xs md:text-sm font-bold tracking-[0.2em] text-gray-700 mb-6 md:mb-8 uppercase opacity-90">
                        [Baekjul-Boolgool]
                    </p>
