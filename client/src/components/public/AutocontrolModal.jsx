...
const AutocontrolModal = ({ isOpen, onClose }) => {
    ...
    return (
        ...
        >
            ...
            >
                {/* Arco Rojo (Según la imagen de Autocontrol) */}
                <div
                    className="absolute -top-[350px] -left-[140px] w-[650px] h-[650px] rounded-full bg-gradient-to-b from-red-100 via-red-400 to-red-600"
                ></div>
                ...
                <div className="relative z-10 px-8 pb-16 pt-8 text-center">
                    ...
                    <div className="mx-auto text-[15px] font-serif tracking-wide text-gray-800 px-2 space-y-4 text-justify">
                        <p className="leading-[1.8]">
                            Consiste en <span className="font-bold text-red-600">dominar las emociones, impulsos y reacciones</span>, blindando el centro en situaciones límite y preservando un juicio pacífico y respetuoso.
                        </p>
                        <p className="leading-[1.8] pt-2">
                            Un verdadero artista del Taekwondo <span className="font-bold text-slate-900 border-b border-red-400">no usa su fuerza sin necesidad</span> y conserva en todo momento el más sofisticado equilibrio mental.
                        </p>
                    </div>
                </div>
            </div>
...
export default AutocontrolModal;