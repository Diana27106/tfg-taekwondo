...
| CP-F-06 | Interacción con el chatbot | Abrir el chatbot flotante y escribir una pregunta | El chatbot devuelve una respuesta en lenguaje natural en menos de 60 s | ✅ OK |
